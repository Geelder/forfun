...
if current_time.hour == 8 and current_time.minute == 0:
    ...
    weather_api_key = '36603adea91a48c7214a124c34e64a7c'  # Замените на ваш ключ API для OpenWeatherMap
    ...
    bot = telebot.TeleBot('6910536186:AAEJA39qoi9hP6IWdEq7kDQloK2RxsfimWQ')  # Замените на ваш токен бота
